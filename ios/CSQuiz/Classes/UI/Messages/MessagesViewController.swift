...
class MessagesViewController: BaseViewController
{
    ...
    override func viewWillAppear(animated: Bool)
    {
        ...
        if (animated)
        {
            ...
            UIView.animateWithDuration(Stylesheet.mediumAnimationDuration, delay: 0, usingSpringWithDamping: 0.75, initialSpringVelocity: 0, options: .CurveEaseOut, animations: { () -> Void in
