...
class MessagesView: UIView
{
    ...
    override func layoutSubviews()
    {
        ...
        messageTextLabel.mc_setPosition(.PositionCenters, withMargins: UIEdgeInsetsZero, size: CGSize(width: mc_width(), height: 36))
        
        let buttonSize = CGSize(width: 56, height: 56)
        logoutButton.mc_setPosition(.PositionTopLeft, withMargins: UIEdgeInsetsZero, size: buttonSize)
        shuffleButton.mc_setPosition(.PositionTopRight, withMargins: UIEdgeInsetsZero, size: buttonSize)
